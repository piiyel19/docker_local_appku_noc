  ...
  <div class="container-fluid">
    ...
    <div class="row">
    	<div class="container">
			...
			<textarea id="demo" class="form-control" name="history"cols="80" label="notes"rows="200" wrap="virtual">
				<?php
	    		$path_helper = $_SERVER['DOCUMENT_ROOT'].'/creator/application/controllers/Test.php';
