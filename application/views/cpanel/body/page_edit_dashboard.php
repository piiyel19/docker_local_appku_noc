<div class="breadcrumb-holder">
  <div class="container-fluid">
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Dashboard Editor</li>
    </ul>
  </div>
</div>
            ...
            <div class="card-body">
                <div class="row">
                  <div class="col-md-4">
                      ...
                      <a href="<?= base_url()?>dashboard" target="_blank"><button class="btn btn-primary" style="float: left">Live Page</button></a>
                  </div>
                </div>
...
<script type="text/javascript">
  function save()
  {
    ...
    if (r == true) {
      ...
      $.ajax({
                  url: '<?= base_url() ?>cpanel/update_dashboard_page',
                  type: 'POST',
                  dataType: 'html',
                  data: data,
                  beforeSend: function() {
