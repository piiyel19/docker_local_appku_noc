<div class="breadcrumb-holder">
  <div class="container-fluid">
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Extra Page Editor</li>
    </ul>
  </div>
</div>
        ...
        <div class="col-lg-12" style="padding-top: 30px;">
          <div class="card">
            <div class="card-header">
              <h4>Extra Page Editor : <?= filename_page($this->uri->segment(3)) ?>
                <span style="float: right">
                  <?php if(!empty(filename_page($this->uri->segment(3)))){ ?>
            ...
            <div class="card-body">
                <div class="row">
                  <div class="col-md-4">
                      ...
                      <a href="<?= base_url().filename_page($this->uri->segment(3))?>" target="_blank"><button class="btn btn-primary" style="float: left">Live Page</button></a>
                  </div>
                </div>
                  ...
                  <div class="col-md-12">
                      ...
                      <textarea id="demo" class="form-control" name="history"cols="80" label="notes" rows="50" wrap="virtual">
                        ...
                        <?php 
                          ...
                          $path_helper = $_SERVER['DOCUMENT_ROOT'].'/application/views/public/page/'.filename_page($this->uri->segment(3)).'.php';
...
<script type="text/javascript">
  function save()
  {
    ...
    if (r == true) {
      ...
      var data =  {
                          'code':code,
                          'file_name': "<?= filename_page($this->uri->segment(3)); ?>",
                          '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'
                  }

      $.ajax({
                  url: '<?= base_url() ?>cpanel/update_extra_page',
                  type: 'POST',
                  dataType: 'html',
                  data: data,
                  beforeSend: function() {
